    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="breadcrumb-holder">
                <h1 class="main-title float-left">Đăng ký thiết bị mới</h1>
                <ol class="breadcrumb float-right">
                    <li class="breadcrumb-item">Trang chủ</li>
                    <li class="breadcrumb-item">Menu quản trị</li>
                    <li class="breadcrumb-item">Quản lí máy</li>
                    <li class="breadcrumb-item active">Đăng kí thiết bị mới</li>
                </ol>
                ...
                <div class="card alert-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" type="text" name="machine_name" value="{{old('machine_name')}}">
                            </div>
                        </div>
